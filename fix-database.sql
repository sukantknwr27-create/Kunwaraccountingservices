-- ================================================================
-- COMPLETE FIX v2 — Drops old tables and recreates correctly
-- PASTE ALL OF THIS IN SUPABASE SQL EDITOR → CLICK RUN
-- ================================================================

-- STEP 1: Drop all old tables (removes old column structure completely)
...
-- STEP 2: Recreate all tables with correct columns
...
-- STEP 4: Create open policies — allow read + write for everyone (anon + authenticated)
...
-- STEP 5: Insert all default data
...
values ('sukant.kunwar@superyes', true, '+91 80761 36300', true,
...
-- Services — Income Tax
insert into services (category, name, fee_range, sort_order) values
...
-- Packages — Individual / Salaried
insert into packages (category, name, price_range, billing_cycle, description, includes, is_popular, sort_order) values
('Individual / Salaried', 'Basic Salaried Plan', '₹2,000 – ₹4,000', 'year',
 'For salaried employees needing annual tax compliance',
 array['ITR Filing (Salaried)', 'Advance Tax Computation', 'WhatsApp support'],
 false, 1),
('Individual / Salaried', 'Investor Plan', '₹5,000 – ₹10,000', 'year',
 'For salaried + investment income',
 array['ITR (Salary + Capital Gains)', 'Tax Advisory & Planning', 'Priority support'],
 true, 2),
('Individual / Salaried', 'NRI Plan', '₹10,000 – ₹25,000', 'year',
 'Complete NRI tax compliance',
 array['ITR (NRI)', 'Form 15CA / 15CB', 'Tax Advisory'],
 false, 3);

-- Packages — Small Business
insert into packages (category, name, price_range, billing_cycle, description, includes, is_popular, sort_order) values
('Small Business', 'GST Monthly', '₹2,000 – ₹4,000', 'month',
 'For GST-registered businesses',
 array['GSTR-1 + GSTR-3B filing', 'GSTR-9 Annual Return', 'Monthly deadline reminders'],
 false, 1),
('Small Business', 'Accounts Pro', '₹4,000 – ₹8,000', 'month',
 'Bookkeeping + full GST compliance',
 array['Bookkeeping + GST Returns', 'TDS Filing (quarterly)', 'P&L + Balance Sheet', 'Priority WhatsApp support'],
 true, 2),
('Small Business', 'Proprietor All-in-One', '₹6,000 – ₹12,000', 'month',
 'Everything under one roof for proprietors',
 array['Bookkeeping + GST', 'ITR Filing (annual, included)', 'TDS (quarterly)', 'Dedicated support'],
 false, 3);

-- Packages — Startups & Companies
insert into packages (category, name, price_range, billing_cycle, description, includes, is_popular, sort_order) values
('Startups & Companies', 'Startup Launch', '₹12,000 – ₹20,000', 'one-time',
 'Get your startup registered and compliant',
 array['Company/LLP Registration', 'GST Registration', 'PAN/TAN Application', 'DSC for directors'],
 false, 1),
('Startups & Companies', 'Startup Growth', '₹8,000 – ₹15,000', 'month',
 'Complete ongoing compliance for startups',
 array['Bookkeeping + GST', 'ITR + TDS Compliance', 'ROC Annual Filing', 'Monthly MIS Reports'],
 true, 2),
('Startups & Companies', 'Startup Premium', '₹15,000 – ₹30,000', 'month',
 'All services + Virtual CFO advisory',
 array['Everything in Growth plan', 'Payroll Management', 'Virtual CFO Advisory', 'Dedicated account manager'],
 false, 3);

-- Packages — Payroll / Employers
insert into packages (category, name, price_range, billing_cycle, description, includes, is_popular, sort_order) values
('Payroll / Employers', 'Payroll Starter', '₹2,000 – ₹4,000', 'month',
 'For small teams up to 5 staff',
 array['Payroll for up to 5 staff', 'PF/ESI Filing', 'Monthly payslips', 'Challan generation'],
 false, 1),
('Payroll / Employers', 'Payroll Pro', '₹4,000 – ₹8,000', 'month',
 'For growing teams up to 20 staff',
 array['Payroll for up to 20 staff', 'PF/ESI Filing', 'Form 16 (annual)', 'Full & Final Settlement'],
 true, 2),
('Payroll / Employers', 'HR Compliance', '₹6,000 – ₹12,000', 'month',
 'Full payroll + statutory compliance',
 array['Full payroll management', 'PF/ESI + TDS on salary', 'Form 16 generation', 'Compliance calendar'],
 false, 3);

-- Packages — Virtual CFO
insert into packages (category, name, price_range, billing_cycle, description, includes, is_popular, sort_order) values
('Virtual CFO', 'Virtual CFO Basic', '₹10,000 – ₹20,000', 'month',
 'Strategic financial management',
 array['Monthly MIS Reports', 'Bookkeeping + GST', 'ITR Filing (annual)', 'Cash flow analysis'],
 false, 1),
('Virtual CFO', 'Virtual CFO Pro', '₹20,000 – ₹40,000', 'month',
 'Complete financial management for growing SMEs',
 array['MIS + Bookkeeping + GST', 'TDS + Payroll + ITR', 'ROC Annual Filing', '2 CFO advisory calls/month', 'Dedicated account manager'],
 true, 2);

-- FINAL CHECK — you should see rows > 0 for all 4 tables
